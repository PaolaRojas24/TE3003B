# Dibujo bidimencional de Baymax usando G-code.
...
# Contar líneas del G-code
with open("baymax_0001.ngc", 'r') as fp:
...
# Ajuste manual de altura (colocar lapiz)
while x != "q":
    if x == "a": 
...
# Lectura de G-code y movimiento para dibujar
with open('baymax_0001.ngc') as gcode:
    for line in gcode:
        line = line.strip()
